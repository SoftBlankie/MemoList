 ...
 */
public class custom_date_time_picker implements View.OnClickListener {
    ...
    public custom_date_time_picker(Activity a,
    ...
    public View getDateTimePickerLayout() {
        ...
        btn_setDate.setBackgroundResource(R.drawable.custom_border_right);
        ...
        btn_setTime.setBackgroundResource(R.drawable.custom_border_left);
        btn_setTime.setText("Time");
